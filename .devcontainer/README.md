...
```Dockerfile
FROM ubuntu:jammy
RUN apt update && apt upgrade -y zsh git
```
...
>This documentation is part of the open-source project [latexdevcontainer](https://github.com/qdm12/latexdevcontainer), created by [@qdm12](https://github.com/qdm12). We have adapted some of its documentation to suit the needs of our project. We thank [Quentin McGaw](https://github.com/qdm12) for sharing their work and allowing us to use it.